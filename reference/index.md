...
- [`plot_play()`](https://swebb1.github.io/ggulti/reference/plot_play.md)
  ...
  arrows.
- [`static_objects()`](https://swebb1.github.io/ggulti/reference/static_objects.md)
  : Create multiple a list of pitch_objects which do not move throughout
  all frames. Objects are represented with geom_point in the plot_play()
